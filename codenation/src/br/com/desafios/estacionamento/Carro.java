...
public class Carro {
    ...
    private Carro(Motorista motorista, String placa, Cor cor) {
    	...
    	if (placa.isEmpty()) throw new NullPointerException();
    	if (Objects.isNull(cor)) throw new NullPointerException();
    	if (Objects.isNull(motorista)) throw new EstacionamentoException("O carro precisa ter um motorista!");
    ...
    public static class CarroBuilder {
        ...
        public CarroBuilder withMotorista(Motorista motorista) {
        	if (motorista.getIdade() < 18) throw new EstacionamentoException("Motorista não pode ser menor de idade!");
            this.motorista = motorista;
            return this;
        }
